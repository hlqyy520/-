...
@interface HQComposeViewController () <HQComposeToolbarDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
@property (nonatomic, weak) UITextView *textView;
@property (nonatomic, weak) HQComposeToolbar *toolbar;
@property (weak, nonatomic) UIImageView *imageView;
@end

@implementation HQComposeViewController
...
- (void)setupToolbar
{
    HQComposeToolbar *toolbar = [[HQComposeToolbar alloc] init];
...
- (void)setupTextView
{
    HQPlaceholderTextView *textView = [[HQPlaceholderTextView alloc] init];
...
{
    switch (buttonType) {
        case HQComposeToolbarButtonTypeCamera: // 照相机
            [self openCamera];
            break;
            
        case HQComposeToolbarButtonTypePicture: // 相册
            [self openAlbum];
            break;
