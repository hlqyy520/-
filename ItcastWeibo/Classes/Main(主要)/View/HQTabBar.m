...
@property (nonatomic, weak) HQTabBarButton *selectedButton;
@end
...
{
    // 1.创建按钮
    HQTabBarButton *button = [[HQTabBarButton alloc] init];
 ...
 *  监听按钮点击
 */
- (void)buttonClick:(HQTabBarButton *)button
{
    // 1.通知代理
...
- (void)layoutSubviews
{
    ...
    for (int index = 0; index<self.tabBarButtons.count; index++) {
        // 1.取出按钮
        HQTabBarButton *button = self.tabBarButtons[index];
